                ...
                <div class="kt-portlet kt-portlet--height-fluid-full" id="kt_page_portlet">
					...
					<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                     ...
                     <div class="form-group row">
						...
						<div class="col-lg-8">
                          <label><span style="color:#ff0000">*</span> Alamat Badan Usaha :</label>
                          <input type="text" class="form-control form-control-sm" placeholder="">
                        </div>
						<div class="col-lg-4">
											...
											<div id="kt_repeater_1">
												<table class="table table-bordered table-hover table-checkable" id="kt_repeater_1">
																								...
																								<tr style="text-align:center">
																								  ...
																								  <td width="10%" bgcolor="#f7fcff">Jenis Kendaraan</td>
																									<td width="1%" bgcolor="#f7fcff">Daya<br>Tampung</td>
																									<td width="10%" bgcolor="#f7fcff">Satuan Tarif</td>
																									<td width="10%" bgcolor="#f7fcff">Durasi</td>
