					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th colspan="6" bgcolor="#f7fcff">Kolektor Bertugas</th>
											...
											<tr style="text-align:center">
											  <th width="2%" bgcolor="#f7fcff">ID Kolektor PLB</th>
											  ...
											  <th width="7%" bgcolor="#feffed">Tarif / Bulan</th>
											  <th width="7%" bgcolor="#feffed">Setoran</th>
										  </tr>
										</thead>
										<tbody>
											<tr>
