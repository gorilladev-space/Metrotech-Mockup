...
<div class="col-lg-4">
                     ...
                     <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Kontrak Selesai">
                        </div>
						<div class="col-lg-4">
						...
						<div class="col-lg-4">
                          ...
                          <div class="form-group">
                         <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="4 Januari 2020">
                      </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                       <div class="col-lg-12">
                          ...
                          <textarea class="form-control" disabled="disabled" id="exampleTextarea" rows="7"></textarea>
                        </div>
                      </div>
                      </div>
                    </div>
																	...
																	<li class="kt-nav__item">
																	  ...
																	  <li class="kt-nav__item">
																		  <div class="kt-nav__link" data-toggle="modal" data-target="#modal_pelunasan">
																			  ...
																			  <span class="kt-nav__link-text">Tasking Selesai</span>
																		  </div>
																	  </li>
