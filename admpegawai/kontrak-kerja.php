							...
							<div class="kt-portlet kt-portlet--mobile ">
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="8%" bgcolor="#f7fcff" rowspan="2">No. SK <br>Pegawai</th>
												<th width="8%" bgcolor="#f7fcff" rowspan="2">No. Perjanjian<br>Kontrak Pegawai</th>
												...
												<th width="8%" bgcolor="#f7fcff" rowspan="2">Bagian</th>
												...
												<th colspan="3" bgcolor="#f7fcff">Verfikasi Perjanjian Kontrak</th>
												<th width="10%" bgcolor="#f7fcff" rowspan="2">Status<br>Perjanjian Kontrak</th>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:left">004/20-S.Kep.Dir/PERUMDA-PMR/XII/2022</td>
												<td style="text-align:left">004/80-KK/PERUMDA-PMR/X/2022</td>
												...
												<td style="text-align:center" nowrap><button type="button" class="btn btn-danger btn-sm btn-icon" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Belum Dibuat"><i class="fa fa-user-slash"></i></button></td>
												...
												<td style="text-align:center" nowrap><button type="button" class="btn btn-warning btn-sm btn-icon kt_sweetalert_demo_setuju" data-toggle="kt-tooltip" data-skin="brand" title="Menunggu Persetujuan" data-html="true"><i class="fa fa-clock"></i></button></td>
												<td style="text-align:center"><span class="kt-badge kt-badge--danger kt-badge--md kt-badge--inline">Belum Dibuat</span></td>
																	...
																	<ul class="kt-nav">
																		...
																		<li class="kt-nav__item">
																			<a href="pegawai-kontrak-detail.php" class="kt-nav__link">
																				...
																				<span class="kt-nav__link-text">Lihat Detail Pegawai</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
											...
											<tr>
												...
												<td style="text-align:left">003/20-S.Kep.Dir/PERUMDA-PMR/XII/2022</td>
												<td style="text-align:left">003/80-KK/PERUMDA-PMR/X/2022</td>
												<td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Amalia Restu Sugiarty S.Tr.Par<hr>Electrical Engineer Supervisor Assistant" data-html="true">
														<img src="../assets/media/users/100_10.jpg" alt="image">
													</a></td>
												<td id="kt_table_1">Sri Suhartini, SE</td>
												...
												<td style="text-align:center" nowrap><button type="button" class="btn btn-success btn-sm btn-icon" data-toggle="kt-tooltip" data-skin="brand" title="Dibuat<hr>Sri Suhartini, SE<br>31 Desember 2018 - 14:30 WITA" data-html="true"><i class="fa fa-user-tie"></i></button></td>
												<td style="text-align:center" nowrap><button type="button" class="btn btn-warning btn-sm btn-icon kt_sweetalert_demo_setuju" data-toggle="kt-tooltip" data-skin="brand" title="Menunggu Persetujuan" data-html="true"><i class="fa fa-clock"></i></button></td>
												<td style="text-align:center" nowrap><button type="button" class="btn btn-warning btn-sm btn-icon kt_sweetalert_demo_setuju" data-toggle="kt-tooltip" data-skin="brand" title="Menunggu Persetujuan" data-html="true"><i class="fa fa-clock"></i></button></td>
												<td style="text-align:center"><span class="kt-badge kt-badge--warning kt-badge--md kt-badge--inline">Menunggu Persetujuan</span></td>
												<td width="1%" style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
																</a>
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	...
																	<li class="kt-nav__item">
																			<a href="hr-view-perjanjian-kontrak.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Perjanjian Kontrak</span>
																			</a>
																		</li>
										  ...
										  <tr>
												...
												<td style="text-align:left">002/20-S.Kep.Dir/PERUMDA-PMR/XII/2022</td>
												<td style="text-align:left">002/80-KK/PERUMDA-PMR/X/2022</td>
												<td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Amalia Restu Sugiarty S.Tr.Par<hr>Electrical Engineer Supervisor Assistant" data-html="true">
														<img src="../assets/media/users/100_10.jpg" alt="image">
													</a></td>
												<td id="kt_table_1">Sri Suhartini, SE</td>
								...
								<i class="fa flaticon2-check-mark"></i>
										  ...
										  <tr>
												...
												<td style="text-align:left">001/20-S.Kep.Dir/PERUMDA-PMR/XII/2022</td>
												<td style="text-align:left">001/80-KK/PERUMDA-PMR/X/2022</td>
												<td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Amalia Restu Sugiarty S.Tr.Par<hr>Electrical Engineer Supervisor Assistant" data-html="true">
														<img src="../assets/media/users/100_10.jpg" alt="image">
													</a></td>
												<td id="kt_table_1">Sri Suhartini, SE</td>
								...
								<i class="fa flaticon2-check-mark"></i>
												...
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Disetujui<hr>Nama Direktur Utama<br>31 Desember 2018 - 14:30 WITA">
								<i class="fa flaticon2-check-mark"></i>
							</span></td>
							<td style="text-align:center"><span class="kt-badge kt-badge--success kt-badge--md kt-badge--inline">Selesai</span></td>
												<td width="1%" style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
																</a>
																	...
																	<li class="kt-nav__item">
																		...
																		<li class="kt-nav__item">
																			<a href="hr-cetak-sk-kontrak-pegawai.php" class="kt-nav__link">
																				<i class="kt-nav__link-icon fa fa-print"></i>
																				<span class="kt-nav__link-text">Cetak SK Pegawai Kontrak</span>
																			</a>
																		</li>
