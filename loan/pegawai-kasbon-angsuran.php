							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="pegawai-kasbon-angsuran-add.php" class="btn btn-info btn-sm">
												<i class="fa fa-plus-circle"></i> Bayar Angsuran</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="2%" bgcolor="#f7fcff">Pegawai<br>Peminjam</th>
												<th width="5%" bgcolor="#f7fcff">ID<br>Kwitansi</th>
												<th width="1%" bgcolor="#f7fcff">Angsuran<br>Ke</th>
												<th width="7%" bgcolor="#f7fcff">Tanggal<br>Pembayaran</th>
												<th width="4%" colspan="2" bgcolor="#f7fcff">Total Pinjaman</th>
												<th width="1%" bgcolor="#f7fcff">Bunga</th>
												<th width="3%" bgcolor="#f7fcff">Tenor</th>
												<th width="4%" colspan="2" bgcolor="#f7fcff">Jumlah<br>Pembayaran</th>
												<th width="4%" colspan="2" bgcolor="#f7fcff">Sisa<br>Pinjaman</th>
												<th width="10%" bgcolor="#f7fcff">Progress<br>Angsuran</th>
										...
										<tbody>
										  ...
										  <tr>
												...
												<td style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Wahyu Djunaedi<hr>Electrical Engineering Supervisor" data-html="true">
														<img src="../assets/media/users/100_6.jpg" alt="image">
													</a></td>
												<td style="text-align:center">1/IM-KW-KASBON/III/2019</td>
