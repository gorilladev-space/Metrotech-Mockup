							...
							<br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
												...
												<div class="col-lg-4">
														<label>No. Rekening Simpanan :</label>
														<input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Auto">
													</div>
											<div class="col-lg-4">
                              ...
                              <option value="HI"></option>
								...
								<div class="col-xl-3">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Upload Lampiran</div>
										 <div class="kt-portlet__body">
                      <div class="form-group row">
                       <div class="col-lg-12">
                          <label>Upload Lampiran Pendukung :</label>
