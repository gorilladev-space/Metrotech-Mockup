								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="pegawai-kasbon-add.php" class="btn btn-info btn-sm">
												<i class="fa fa-plus-circle"></i> Buat Kasbon Baru</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
						...
						<div class="alert alert-elevate alert-solid-warning alert-bold" role="alert">
        							...
        							<span class="kt-input-icon__icon kt-input-icon__icon--right">
    		                            <span><i class="la la-search"></i></span>
						                        ...
						                        <div class="col-lg-2">
						                          <label class="">Nilai Pinjaman :</label>
						                          <input type="text" class="form-control form-control-sm">
						                        </div>
												<div class="col-lg-1">
						                          <label class="">Tenor :</label>
						                          <select class="form-control kt-selectpicker" data-live-search="true" tabindex="-98">
                              <option value="AK">1 Bulan</option>
                              <option value="HI">2 Bulan</option>
                              <option value="HI">3 Bulan</option>
                              <option value="HI">4 Bulan</option>
                              <option value="HI">5 Bulan</option>
                              <option value="HI">6 Bulan</option>
                              <option value="HI">7 Bulan</option>
                              <option value="HI">8 Bulan</option>
                              <option value="HI">9 Bulan</option>
                              <option value="HI">10 Bulan</option>
                              <option value="HI">11 Bulan</option>
                              <option value="HI">12 Bulan</option>
                              <option value="HI">18 Bulan</option>
                              <option value="HI">24 Bulan</option>
                            </select>
						                        </div>
												<div class="col-lg-1">
						                          <label>Status :</label>
...
<!--begin:: Widgets/Stats-->
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="5%" bgcolor="#f7fcff" rowspan="2">ID Kasbon</th>
												<th width="7%" bgcolor="#f7fcff" rowspan="2">Waktu<br>Pengajuan</th>
												<th width="6%" colspan="2" rowspan="2" bgcolor="#f7fcff">Nilai Pinjaman</th>
												<th width="1%" bgcolor="#f7fcff" rowspan="2">Bunga</th>
												<th width="3%" bgcolor="#f7fcff" rowspan="2">Tenor</th>
												<th width="4%" colspan="2" rowspan="2" bgcolor="#f7fcff">Angsuran</th>
												<th width="6%" colspan="2" rowspan="2" bgcolor="#f7fcff">Sisa Pinjaman</th>
												<th width="6%" rowspan="2" bgcolor="#f7fcff">Progress Angsuran</th>
												<th colspan="4" bgcolor="#f7fcff">Verifikasi</th>
												<th width="1%" bgcolor="#f7fcff" rowspan="2">Status Permohonan</th>
  ...
  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 80%">8 dari 10</div>
										  ...
										  <tr>
												...
												<td style="text-align:center;">1/IM-KASBON/III/2019</td>
												<td style="text-align:center">12 Oktober 2019 - 09:00 WITA</td>
												<td style="text-align:left; border-right-color:#fff">Rp.</td>
												<td style="text-align:right;">1.000.000,-</td>
												<td style="text-align:right">0 %</td>
  ...
  <div class="progress-bar bg-success progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 100%">100%</div>
												...
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Disetujui" data-html="true">
												 ...
												 <td style="text-align:center" nowrap><div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	<ul class="kt-nav">
																	<li class="kt-nav__item">
																			<div class="kt-nav__link" data-toggle="modal" data-target="#modal_angsuran2">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Angsuran</span>
																			</div>
																		</li>
										  ...
										  <tr>
												...
												<td style="text-align:center;">3/IM-KASBON/III/2019</td>
												<td style="text-align:center">12 Oktober 2019 - 09:00 WITA</td>
												<td style="text-align:left; border-right-color:#fff">Rp.</td>
												<td style="text-align:right;">1.000.000,-</td>
												<td style="text-align:right">0 %</td>
												...
												<td style="text-align:right">1.000.000,-</td>
												<td style="text-align:center" nowrap><div class="progress">
  <div class="progress-bar bg-danger progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="1" style="width: 10%">0%</div>
</div></td>
											  <td style="text-align:center" nowrap><button type="button" class="btn btn-warning btn-sm btn-icon kt_sweetalert_demo_setuju" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Menunggu Persetujuan"><i class="fa fa-clock"></i></button></td>
												<td style="text-align:center" nowrap><button type="button" class="btn btn-warning btn-sm btn-icon kt_sweetalert_demo_setuju" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Menunggu Persetujuan"><i class="fa fa-clock"></i></button></td>
												<td style="text-align:center" nowrap><button type="button" class="btn btn-warning btn-sm btn-icon kt_sweetalert_demo_setuju" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Menunggu Persetujuan"><i class="fa fa-clock"></i></button></td>
												<td style="text-align:center" nowrap><button type="button" class="btn btn-danger btn-sm btn-icon" data-toggle="kt-tooltip" data-skin="brand" title="Belum Terbayar"><i class="fa fa-money-bill-alt"></i></button></td>
												<td style="text-align:center" nowrap><button type="button" class="btn btn-warning btn-sm btn-icon kt_sweetalert_demo_setuju" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Menunggu Persetujuan"><i class="fa fa-clock"></i></button></td>
												 <td style="text-align:center" nowrap><div class="kt-widget2__actions">
																<a href="#" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="flaticon-more-1"></i>
																...
																<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
																	...
																	<li class="kt-nav__item">
																			<div class="kt-nav__link" data-toggle="modal" data-target="#modal_angsuran2">
																				<i class="kt-nav__link-icon fa fa-eye"></i>
																				<span class="kt-nav__link-text">Lihat Permohonan</span>
																			</div>
																		</li>
								...
								<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												<span class="kt-portlet__head-icon"><i class="kt-font-brand flaticon2-list"></i></span>
												<h3 class="kt-portlet__head-title kt-font-danger">FORM BAYAR ANGSURAN</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
