					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										...
										<tbody>
											<tr>
												...
												<td style="text-align:center;" nowrap><button type="button" class="btn btn-outline-danger btn-sm btn-icon" data-toggle="modal" data-target="#modal_setoran_koordinator_pos" data-skin="" title="" data-html="true" data-original-title="Buat Setoran Jukir"><i class="fa fa-hand-holding-usd"></i></button></td>
												<td style="text-align:left; border-right: 1px solid #fff" nowrap>Rp.</td>
												<td nowrap="nowrap" style="text-align:right">1.500.000,-</td>
												<td style="text-align:center;" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Tunai<hr>Siti Aminah Alibaba<hr>31 Januari 2023 - 14:30 WITA">
															<i class="fa fa-check"></i>
														</span></td>
												<td style="text-align:left; border-right: 1px solid #fff" nowrap>Rp.</td>
												<td nowrap="nowrap" style="text-align:right">1.500.000,-</td>
												<td style="text-align:center;" nowrap><span class="kt-badge kt-badge--info kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Non Tunai<hr>Transfer Bank<hr>31 Januari 2023 - 14:30 WITA">
															<i class="fa fa-check"></i>
														</span></td>
												<td style="text-align:left; border-right: 1px solid #fff" nowrap>Rp.</td>
												<td nowrap="nowrap" style="text-align:right">-</td>
...
<tr>
										  ...
										  <tr bgcolor="#feffed";>
										    <td colspan="5" id="kt_table_3" style="text-align:center" bgcolor="#feffed"><strong>Total Setoran</strong></td>
  ...
  window.history.back();
				...
				<button type="button" class="btn btn-brand">
					...
					<span class="kt-hidden-mobile">Simpan</span>
							...
							<!--End::Modal 2-->
							<!--begin::Modal 1-->
									<div class="modal fade" id="modal_setoran_koordinator_pos" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												<span class="kt-portlet__head-icon"><i class="kt-font-brand flaticon2-list"></i></span>
												<h3 class="kt-portlet__head-title kt-font-danger">FORM SETORAN KOORDINATOR POS KOMERSIL</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
					   ...
					   <label>Nama Kasir</label>
						...
						<div class="col-lg-4">
                         ...
                         <input type="text" class="form-control form-control-sm"  disabled="disabled" placeholder="0000001TKKJU823">

                        </div>
						<div class="col-lg-4">
														<label>ID Pembayaran :</label>
														<input type="text" class="form-control form-control-sm"  disabled="disabled" placeholder="00001PKK823">
													</div>
                        ...
                        <button type="button" class="btn btn-secondary btn-square btn-sm col-lg-12" id="hide1">Tunai</button>

                        </div>
						<div class="col-lg-4">
														<label>&nbsp;</label>
														<button type="button" class="btn btn-secondary btn-square btn-sm col-lg-12" id="show">Non Tunai</button>
													</div>
						...
						<div class="form-group row">
									...
									<!--begin::Portlet-->
									<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail Koordinator</div><br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
												<div class="form-group row">

						<div class="col-lg-4">
                          <label><span style="color:#ff0000">*</span> ID Koordinator :</label>
                         <input type="text" class="form-control form-control-sm"  disabled="disabled" placeholder="0000001TKMTJU823">

                        </div>
						<div class="col-lg-4">
                          <label><span style="color:#ff0000">*</span> Nama Koordinator :</label>
						...
						<div class="col-lg-4">
                         ...
                         <input type="text" class="form-control form-control-sm"  disabled="disabled" placeholder="000 000 000">
									...
									<!--begin::Portlet-->
									<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail Petugas Pos</div><br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
...
<div class="col-lg-3">
						...
						<div class="col-lg-6">
                          <label><span style="color:#ff0000">*</span> Nama Petugas Pos :</label>
                         <input type="text" class="form-control form-control-sm"  disabled="disabled" placeholder="Syarif Dg Kulle">
						...
						<div class="col-lg-6">
                          <label><span style="color:#ff0000">*</span> Pos :</label>
						...
						<div class="col-lg-4">
                          <label>ID Setoran Petugas POS :</label>
                         <input type="text" class="form-control form-control-sm"  disabled="disabled" placeholder="0000001TSPK823">

                        </div>
						
						<div class="col-lg-4">
                          <label>Tanggal Setoran Petugas POS :</label>
                         <input type="text" class="form-control form-control-sm"  disabled="disabled" placeholder="28/08/23 - 14:30 WITA">

                        </div>
						<div class="col-lg-4">
                          <label>Jumlah Setoran Petugas Pos :</label>
                        <div class="form-group">
													<div class="input-group input-group-sm">
														<div class="input-group-prepend"><span class="input-group-text input-group-sm" id="basic-addon1">Rp.</span></div>
														<input type="text" style="text-align:right" class="form-control form-control-sm" disabled="disabled" placeholder="4.050.000" aria-describedby="basic-addon1">
														<div class="input-group-append"><span class="input-group-text input-group-sm" id="basic-addon1">,-</span></div>
													</div>
												</div>
