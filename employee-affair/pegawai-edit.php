													...
													<tr>
														...
														<td style="text-align:center" nowrap>
															...
															<a href="javascript:;" data-repeater-delete="" >
																	<button type="button" class="btn btn-label-danger btn-elevate btn-sm btn-icon" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Hapus Data"><i class="flaticon2-trash"></i></button>
															</a>
														</td>
													</tr>
								...
								<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_repeater_4">
									...
									<tbody data-repeater-list="">
										<tr>
											...
											<td style="text-align:left" nowrap>
												<input type="text" class="form-control form-control-sm" value="0411-430233 / 082244444436" style="border:none !important; background:transparent">
											</td>
											<td style="text-align:center" nowrap>
