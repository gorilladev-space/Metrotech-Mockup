								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="mutasi-pegawai-form.php" class="btn btn-info btn-sm">
												<i class="fa fa-plus"></i> Buat Mutasi</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
                                      ...
                                      <option value="3" selected="">9130038 - Maghfirah Sharifudin Andy Omar S.Psi</option>
												...
												<div class="col-lg-1">
						                          <label>Tipe Mutasi :</label>
																			<select class="form-control kt-selectpicker" data-live-search="true">
			                                      <option value="2" selected="">Mutasi Jabatan</option>
			                                      <option value="2">Mutasi Kantor</option>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="m_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="5%" bgcolor="#f7fcff" rowspan="2">No. Mutasi</th>
												<th width="1%" rowspan="2" bgcolor="#f7fcff">Dibuat Oleh</th>
												<th colspan="3" bgcolor="#f7fcff">Penerima Mutasi</th>
												<th width="8%" bgcolor="#f7fcff" rowspan="2">Tipe Mutasi</th>
											...
											<tr>
											  ...
											  <th width="15%" bgcolor="#f7fcff">Asal</th>
											  <th width="15%" bgcolor="#f7fcff">Tujuan</th>
										...
										<tbody>
											<tr>
												...
												<td id="kt_table_1">001MUHRXI2022</td>
