												...
												<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_repeater_2">
																								...
																								<tr data-repeater-item>
																								  <td style="text-align:center">1</td>
																									<td style="text-align:left"><textarea class="form-control" id="exampleTextarea" rows="5" placeholder="bahwa untuk kebutuhan sumber daya manusia (SDM) PERUMDA Parkir Makassar Raya dianggap perlu mengangkat Pegawai Kontrak menjadi Calon Pegawai untuk mengisi formasi yang lowong pada PERUMDA Parkir Makassar Raya "></textarea></td>
																								...
																								<tr data-repeater-item>
																								  <td style="text-align:center">2</td>
																									<td style="text-align:left"><textarea class="form-control" id="exampleTextarea" rows="5" placeholder="bahwa setelah memperhatikan kemampuan Perusahaan dan masa kerja yang namanya tersebut dalam Lampiran Keputusan ini dianggap cakap dan memenuhi syarat untuk diangkat menjadi Calon Pegawai PERUMDA Parkir Makassar Raya"></textarea></td>
																									<td style="text-align:center"><a href="javascript:;" data-repeater-delete="" class="btn btn-outline-hover-danger btn-sm btn-icon" data-toggle="dropdown"><i class="fa flaticon2-trash"></i></a></td>
																								...
																								<tr data-repeater-item>
																								  <td style="text-align:center">3</td>
																									<td style="text-align:left"><textarea class="form-control" id="exampleTextarea" rows="3" placeholder="bahwa untuk maksud pada huruf a dan huruf b dituangkan dalam Surat Keputusan Direksi PERUMDA Parkir Makassar Raya."></textarea></td>
																									<td style="text-align:center"><a href="javascript:;" data-repeater-delete="" class="btn btn-outline-hover-danger btn-sm btn-icon" data-toggle="dropdown"><i class="fa flaticon2-trash"></i></a></td>
												...
												<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_repeater_5">
																								...
																								<tr data-repeater-item>
																								  <td style="text-align:center">KEDUA</td>
																									<td style="text-align:left"><textarea class="form-control" id="exampleTextarea" rows="2" placeholder="Keputusan ini mulai berlaku terhitung sejak tanggal ditetapkan, dan apabila dikemudian hari terdapat kesalahan/kekeliruan dalam Keputusan ini, maka akan dilakukan perbaikan seperlunya. "></textarea></td>
																									<td style="text-align:center"><a href="javascript:;" data-repeater-delete="" class="btn btn-outline-hover-danger btn-sm btn-icon" data-toggle="dropdown"><i class="fa flaticon2-trash"></i></a></td>
