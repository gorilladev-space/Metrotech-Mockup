							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">
										...
										&nbsp;
										&nbsp;
											Form Pengangkatan Pegawai Tetap
									</h3>
...
<div class="col-lg-4">
                     ...
                     <div class="form-group row">
						<div class="col-lg-4">
                          <label class="">Tanggal SK Pegawai Tetap :</label>
                          <div class="form-group">
						...
						<div class="col-lg-4">
                          <label class="">Department Baru :</label>
                          <div class="form-group">
                         <div class="input-group date">
													<input type="text" class="form-control form-control-sm" readonly="" placeholder="= Pilih Tanggal =" id="kt_datepicker_2">
													<div class="input-group-append">
						...
						<div class="col-lg-4">
                         ...
                         <div class="input-group date">
							...
							<!--end:: Portlet-->
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Berita Acara Direksi</div>
										 <div class="kt-portlet__body">
                      <div class="form-group row">
                       <div class="col-lg-12">
                          <label>Upload Berita Acara Direksi :</label>
