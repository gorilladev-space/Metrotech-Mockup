							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">
										...
										&nbsp;
										&nbsp;
											Data Surat Pengangkatan Pegawai Tetap
									</h3>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="4%" bgcolor="#f7fcff" rowspan="2">Nip</th>
												<th width="15%" bgcolor="#f7fcff" rowspan="2">Department</th>
												<th width="4%" bgcolor="#f7fcff" rowspan="2">Kantor</th>
												<th width="8%" bgcolor="#f7fcff" rowspan="2">No. Surat Pengangkatan <br>Pegawai</th>
												<th width="8%" bgcolor="#f7fcff" rowspan="2">Tanggal Pengangkatan <br>Pegawai</th>
										...
										<tbody>
											<tr>
												...
												<td width="2%" id="kt_table_1">000 000 000</td>
												<td width="15%" style="text-align:left">Commercial & Business Development</td>
												...
												<td style="text-align:left">Telah diangkat menjadi karyawan tetap</td>
																	...
																	<li class="kt-nav__item">
																		...
																		<li class="kt-nav__item">
																			<a href="hr-cetak-pengangkatan.php" class="kt-nav__link">
																				...
																				<span class="kt-nav__link-text">Cetak SK Pengangkatan</span>
																			</a>
																		</li>
