									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="8%" bgcolor="#f7fcff" rowspan="2">Acc Bank</th>
												<th width="8%" bgcolor="#f7fcff" rowspan="2">Acc Number</th>
											...
											<tr>
												...
												<th width="1%" bgcolor="#f7fcff">Accounting & Tax Supervisor</th>
												<th width="1%" bgcolor="#f7fcff">Fianace Manager</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												...
												<td width="8%" style="text-align:center">Januari 2020</td>
												<td width="8%" style="text-align:center">Mandiri</td>
												<td width="8%" style="text-align:center">1740001730332</td>
												<td style="text-align:center">Gaji Sudah Diterima</td>
