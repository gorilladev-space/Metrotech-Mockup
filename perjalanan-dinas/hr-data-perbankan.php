											...
											<div class="kt-widget kt-widget--user-profile-1">
												...
												<div class="kt-widget__body">
													...
													<div class="kt-widget__items">
														...
														<a href="hr-data-sertifikat.php" class="kt-widget__item kt-widget__item--active">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																	    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                       ...
                       <div class="col-lg-2">
                          <label>Tahun :</label>
													<select class="form-control kt-selectpicker">
 																...
 																<option value="HI">2001</option>
 																<option value="HI">2002</option>
 																<option value="HI">2003</option>
 																<option value="HI">2004</option>
							...
							<div>&nbsp;</div>
										...
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="35%" bgcolor="#f7fcff">Nama Pelatihan</th>
											  <th width="35%" bgcolor="#f7fcff">Lokasi</th>
											  <th width="20%" bgcolor="#f7fcff">Tahun</th>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:center" nowrap>Pelatihan Jaringan Komputer</td>
												<td style="text-align:left" nowrap>Telkom Indonesia</td>
