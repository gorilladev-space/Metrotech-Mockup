				...
				<div class="kt-portlet__body">
					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										...
										<tbody>
											<tr>
												<td>1</td>
												<td align="left" valign="left" style="text-align:left">Surat Perintah Perjalanan Dinas</td>
												<td align="left" valign="left" style="text-align:left">003/10.1/PERUMDA-PMR/XII/2022</td>
										  ...
										  <tr>
												<td>2</td>
												<td align="left" valign="left" style="text-align:left">Surat Tugas Perjalanan Dinas</td>
												<td align="left" valign="left" style="text-align:left">097/80.3/PERUMDA-PMR/ST/XII/2022</td>
												<td align="center" valign="center" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Sri Suhartini, SE<hr>Kepala Seksi Administrasi Kepegawaian" data-html="true">
														<img src="../assets/media/users/100_16.jpg" alt="image">
													</a></td>
												<td align="left" valign="left" style="text-align:left">Muhammad Nasrullah, S.Kom</td>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-info">FORM TAMBAH PENOMORAN</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">X</button>
											</div>
