      ...
      <!-- begin:: Content Head -->
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-2">
                          ...
                          <div class="dropdown bootstrap-select form-control kt-"><select class="form-control form-control-sm kt-selectpicker" data-live-search="true" tabindex="-98">
                        ...
                        <div class="col-lg-2">
                          ...
                          <div class="dropdown bootstrap-select form-control kt-"><select class="form-control form-control-sm kt-selectpicker" data-live-search="true" tabindex="-98">
                              ...
                              <option value="5">cuti khusus</option>
                              <option value="6">cuti sakit</option>
                              <option value="7" selected="">Electrical Engineering Supervisor Assistant</option>
                              <option value="12">menikah</option>
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="5%" bgcolor="#f7fcff">Profil</th>
										...
										<tbody>
											<tr>
												...
												<td width="3%" style="text-align:center" nowrap><div class="progress" style="height: 5px;width: 100%;">
															<div class="progress-bar progress-bar-striped progress-bar-animated bg-danger" role="progressbar" style="width: 10%;" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
														</div>
																	...
																	<li class="kt-nav__item">
																		...
																		<li class="kt-nav__item">
																			<a href="hr-pegawai-edit.php" class="kt-nav__link">
																				...
																				<span class="kt-nav__link-text">Lengkapi Profil</span>
																			</a>
																		</li>
																		<li class="kt-nav__item">
											...
											<tr>
												...
												<td width="1%" style="text-align:center" nowrap>9130002</td>
											...
											<tr>
												...
												<td width="1%" style="text-align:center" nowrap>9130003</td>
										  ...
										  <tr>
												...
												<td width="1%" style="text-align:center" nowrap>9130004</td>
