...
<div class="alert alert-elevate alert-solid-warning alert-bold" role="alert">
						                      ...
						                      <div class="form-group row">
												 <div class="col-lg-3">
						                          <label>Pembuat Mutasi :</label>
												  <input type="text" class="form-control form-control-sm" placeholder="9130037 - Maghfirah Sharifudin Andy Omar S.Psi">

						                        </div>
						                        <div class="col-lg-3">
						                          <label>Penerima Mutasi :</label>
												  <input type="text" class="form-control form-control-sm" placeholder="9130037 - Maghfirah Sharifudin Andy Omar S.Psi">
						                     ...
						                     <div class="form-group row">
						                      ...
						                      <div class="dropdown bootstrap-select form-control kt-"><select class="form-control form-control-sm kt-selectpicker" data-live-search="true" tabindex="-98">
						                              ...
						                              <option value="7" selected="">cuti tahunan</option>
						                              <option value="12">menikah</option>
						                          </select><button type="button" class="btn dropdown-toggle btn-light" data-toggle="dropdown" role="combobox" aria-owns="bs-select-1" aria-haspopup="listbox" aria-expanded="false" title="cuti tahunan"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">Kontrak</div></div> </div></button><div class="dropdown-menu "><div class="bs-searchbox"><input type="text" class="form-control" autocomplete="off" role="combobox" aria-label="Search" aria-controls="bs-select-1" aria-autocomplete="list"></div><div class="inner show" role="listbox" id="bs-select-1" tabindex="-1"><ul class="dropdown-menu inner show" role="presentation"></ul></div></div></div>
						                        </div>
												<div class="col-lg-3">
						                      ...
						                      <div class="dropdown bootstrap-select form-control kt-"><select class="form-control form-control-sm kt-selectpicker" data-live-search="true" tabindex="-98">
						                              ...
						                              <option value="7" selected="">cuti tahunan</option>
						                              <option value="12">menikah</option>
						                          </select><button type="button" class="btn dropdown-toggle btn-light" data-toggle="dropdown" role="combobox" aria-owns="bs-select-1" aria-haspopup="listbox" aria-expanded="false" title="cuti tahunan"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">Menunggu Persetujuan</div></div> </div></button><div class="dropdown-menu "><div class="bs-searchbox"><input type="text" class="form-control" autocomplete="off" role="combobox" aria-label="Search" aria-controls="bs-select-1" aria-autocomplete="list"></div><div class="inner show" role="listbox" id="bs-select-1" tabindex="-1"><ul class="dropdown-menu inner show" role="presentation"></ul></div></div></div>
						                        </div>
						                       <div class="col-lg-3">
