									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="2%" bgcolor="#f7fcff" rowspan="2">Petugas</th>
												<th width="8%" bgcolor="#f7fcff" rowspan="2">Waktu<br>Input</th>
												<th width="8%" bgcolor="#f7fcff" rowspan="2">Nama<br>Pengunjung</th>
												<th width="15%" bgcolor="#f7fcff" rowspan="2">Alamat<br>Pengunjung</th>
												<th width="8%" bgcolor="#f7fcff" rowspan="2">No. Tlp / Wa</th>
												<th width="8%" bgcolor="#f7fcff" rowspan="2">Instansi</th>
												<th width="2%" colspan="3" bgcolor="#f7fcff">Tujuan Kunjungan</th>
												<th width="20%" bgcolor="#feffed" rowspan="2">Maksud Kunjungan</th>
											...
											<tr>
											  ...
											  <th width="1%" bgcolor="#f7fcff">Department</th>
											  <th width="2%" bgcolor="#f7fcff">Bagian</th>
											  <th width="8%" bgcolor="#feffed">Mulai </th>
												<th width="8%" bgcolor="#feffed">Berakhir </th>
											</tr>
										</thead>
										<tbody>
											<tr>
