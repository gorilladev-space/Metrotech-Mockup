					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										...
										<tbody>
											<tr>
												...
												<td width="3%" style="text-align:center" nowrap>Rp.</td>
								...
								<i class="fa flaticon2-check-mark"></i>
											...
											<tr>
												...
												<td style="text-align:center" nowrap>24 September 2008</td>
												<td style="text-align:center" nowrap>Pusat</td>
												<td width="3%" nowrap style="text-align:center">Rp.</td>
								...
								<i class="fa flaticon2-check-mark"></i>
										  ...
										  <tr>
										    <td colspan="11" id="kt_table_3" style="text-align:center" bgcolor="#fdfdec"><strong>GRAND TOTAL</strong></td>
										    <td nowrap="nowrap" style="text-align:center" bgcolor="#fdfdec"><strong>Rp.</strong></td>
										    <td nowrap="nowrap" style="text-align:right" bgcolor="#fdfdec"><strong>5.000.000,-</strong></td>
										    <td nowrap="nowrap" style="text-align:center" bgcolor="#fdfdec"><strong>Rp.</strong></td>
										    <td nowrap="nowrap" style="text-align:right" bgcolor="#fdfdec"><strong>500.000,-</strong></td>
										    <td nowrap="nowrap" style="text-align:center" bgcolor="#fdfdec"><strong>Rp.</strong></td>
										    <td nowrap="nowrap" style="text-align:right" bgcolor="#fdfdec"><strong>4.500.000-</strong></td>
