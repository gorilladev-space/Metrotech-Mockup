					...
					<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead>
											<tr style="text-align:center">
											  ...
											  <th width="1%" rowspan="2" bgcolor="#f7fcff">NIS</th>
										...
										<tbody>
											<tr>
												...
												<td nowrap="nowrap" style="text-align:center">1 Januari 2019 - 7 Januari 2019</td>
										  ...
										  <tr>
												...
												<td width="1%" nowrap style="text-align:center">Rp.</td>
												<td width="3%" nowrap style="text-align:right">4.500.000-</td>
												<td style="text-align:center" nowrap><a type="button" href="gaji-pegawai-harian-add.php" class="btn btn-danger btn-sm btn-icon" data-toggle="kt-tooltip" data-skin="brand" title="" data-html="true" data-original-title="Belum Dibuat"><i class="fa fa-calculator"></i></a></td>
