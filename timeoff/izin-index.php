							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
										...
										<a href="#" class="btn btn-label-success btn-sm" data-toggle="dropdown">
											...
											<a href="hr-pegawai-izin-add.php" class="btn btn-label-info btn-sm">
												<i class="fa fa-calculator"></i> Form Izin</button>
												<!--<i class="flaticon2-plus"></i>-->
											</a>
...
<div class="alert alert-elevate alert-solid-warning alert-bold" role="alert">
        							...
        							<input type="text" class="form-control form-control-sm" placeholder="Pencarian Data..." id="generalSearch">
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="20%" rowspan="2" bgcolor="#f7fcff">Keterangan</th>
										...
										<tbody>
											<tr>
												...
												<td style="text-align:center">Bagian Umum</td>
										  ...
										  <tr>
											  ...
											  <td style="text-align:left">Antar Anak Sekolah Hari Pertama </td>
												<td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Disetujui<hr>Muhammad Nasrullah, S.Kom<br>31 Desember 2018 - 14:30 WITA" data-html="true">
													...
													<td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Disetujui<hr>Nama Kabag Terkait<br>31 Desember 2018 - 14:30 WITA" data-html="true">
															<i class="fa flaticon2-check-mark"></i>
														</span></td>
														<td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Disetujui<hr>Nama Direksi Terkait<br>31 Desember 2018 - 14:30 WITA" data-html="true">
															<i class="fa flaticon2-check-mark"></i>
														</span></td>
