              ...
              <div class="col-lg-12">
                <div class="kt-portlet kt-portlet--height-fluid-full" id="kt_page_portlet">
					...
					<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Setup Cuti</div>
										 <div class="kt-portlet__body">
...
<div class="col-lg-4">
						...
						<div class="form-group row">
                                ...
                                <div class="kt-section__content kt-section__content--solid" role="group" aria-label="...">
      													...
      													<button type="button" class="btn btn-secondary btn-square btn-sm col-lg-4" id="hide2">Tanggal Bergabung Staff</button>&nbsp;
                                <button type="button" class="btn btn-secondary btn-square btn-sm col-lg-4" id="show">Tanggal Tertentu</button>&nbsp;
      												</div>
                              	</div>
      												</div>
      												</div>
						...
						<div class="col-lg-5">
                          ...
                          <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Staf Muda / C.1">
							...
							<!--end:: Portlet-->
										...
										<tbody>
											<tr>
											  <td colspan="9" bgcolor="#fdfdec">Direksi</td>
										  </tr>
											<tr>
												<td>1</td>
												...
												<td style="text-align:center">238 004 032</td>
										  ...
										  <tr>
										    <td colspan="9" bgcolor="#fdfdec">Umum dan Kepegawaian</td>
									      </tr>
										  <tr>
												<td>1</td>
												<td align="center" valign="middle" style="text-align:center"><a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" title="" data-original-title="Amalia Restu Sugiarty S.Tr.Par" data-html="true">
