							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Data Penugasan</div><br>
										<div class="kt-portlet__body">
											<div class="kt-portlet__content">
												<div class="form-group row">
																					<div class="col-lg-6">
																						<label>QR Code Mitra Insidentil :</label>
...
<div class="col-lg-6">
                     ...
                     <div class="form-group row">
						<div class="col-lg-10">
																						...
																						<select class="form-control kt-selectpicker" data-live-search="true">
                                      <option value="1" selected>Patung Ayam Daya</option>
                                      <option value="2">Jurana Textil</option>
                                      <option value="3">Graha Nurtasnim</option>
                                      <option value="4">Balai Kencana</option>
                                      <option value="5">Coto Bahagia Sudiang</option>
                                      <option value="6">Taman Kota Maccini Sombala</option>
                                      <option value="7">Klinik Tajuddin</option>
                                      <option value="8">Car Free Daya Boulevard</option>
