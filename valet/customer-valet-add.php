							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">
										...
										&nbsp;
										&nbsp;
											Form Tambah Customer - Valet Parking
									</h3>
...
<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
					...
					<div class="col-xl-2">
							...
							<!--end:: Portlet-->
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail PKS</div><br>
										 <div class="kt-portlet__body">
											<div class="kt-portlet__content">
												<div class="form-group row">
						 ...
						 <div class="col-lg-12">
                          ...
                          <input type="text" class="form-control form-control-sm" placeholder="001/PKS/VP/I/2023" disabled>
                        </div>
...
<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
  ...
  <tr>
    <td colspan="12" style="text-align: center"><strong>VALET PARKING BLOK SPACE</strong></td>
  </tr>
  <tr>
