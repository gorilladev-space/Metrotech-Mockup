								...
								<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="kt-portlet__head-label">
												...
												<h3 class="kt-portlet__head-title kt-font-danger">FORM ZONA TUGAS JUKIR VALET</h3>
											</div>
									...
									<input type="text" class="form-control form-control-sm" placeholder="Bakung" disabled>
												...
												<div class="col-lg-6">
														...
														<select class="form-control kt-selectpicker" data-live-search="true">
                                      <option value="1" >Toko Agung</option>
                                      <option value="2">Mall Ratu Indah</option>
                                      <option value="3" selected="">Mall Panakkukang</option>
