...
<div class="kt-subheader  kt-grid__item" id="kt_subheader">
                    ...
                    <!--START - Projects list-->
										<div class="row">
											<div class="col-lg-3">
												<div class="kt-portlet kt-portlet--height-fluid kt-iconbox kt-iconbox--danger kt-iconbox--animate-slower">
										...
										<div class="row mt-6">
											...
											<div class="col-lg-6">
												<b><span class="kt-badge kt-badge--success kt-badge--md kt-badge--inline">08:00:00 WITA</span></b>
											</div>
										</div>
										<div><br></div>
										<div class="row mt-6">
											...
											<div class="col-lg-6">
												<span class="kt-badge kt-badge--danger kt-badge--md kt-badge--inline">Belum Absen</span>
											</div>
										</div>
    ...
    <g id="Stockholm-icons-/-Home-/-Timer" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M11.9630156,7.5 L12.0369844,7.5 C12.2982526,7.5 12.5154733,7.70115317 12.5355117,7.96165175 L12.9585886,13.4616518 C12.9797677,13.7369807 12.7737386,13.9773481 12.4984096,13.9985272 C12.4856504,13.9995087 12.4728582,14 12.4600614,14 L11.5399386,14 C11.2637963,14 11.0399386,13.7761424 11.0399386,13.5 C11.0399386,13.4872031 11.0404299,13.4744109 11.0414114,13.4616518 L11.4644883,7.96165175 C11.4845267,7.70115317 11.7017474,7.5 11.9630156,7.5 Z" id="Path-107" fill="#000000"></path>
															...
															<div class="kt-notification__item-details">
																...
																13 Desember 2019 - 15:00 WITA - By <b>Muhammad Nasrullah</b>
																</div>
															</div>
        ...
        <path d="M11.9630156,7.5 L12.0369844,7.5 C12.2982526,7.5 12.5154733,7.70115317 12.5355117,7.96165175 L12.9585886,13.4616518 C12.9797677,13.7369807 12.7737386,13.9773481 12.4984096,13.9985272 C12.4856504,13.9995087 12.4728582,14 12.4600614,14 L11.5399386,14 C11.2637963,14 11.0399386,13.7761424 11.0399386,13.5 C11.0399386,13.4872031 11.0404299,13.4744109 11.0414114,13.4616518 L11.4644883,7.96165175 C11.4845267,7.70115317 11.7017474,7.5 11.9630156,7.5 Z" id="Path-107" fill="#000000"></path>
															...
															<div class="kt-notification__item-details">
																...
																<div class="kt-notification__item-time">
																12 Desember 2019 - 15:00 WITA - By <b>Muhammad Nasrullah</b>
																</div>
															</div>
															<div onclick="window.location='#';" class="btn btn btn-outline-danger btn-elevate  btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="fa fa-eye"></i>
    ...
    <g id="Stockholm-icons-/-Home-/-Timer" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M11.9630156,7.5 L12.0369844,7.5 C12.2982526,7.5 12.5154733,7.70115317 12.5355117,7.96165175 L12.9585886,13.4616518 C12.9797677,13.7369807 12.7737386,13.9773481 12.4984096,13.9985272 C12.4856504,13.9995087 12.4728582,14 12.4600614,14 L11.5399386,14 C11.2637963,14 11.0399386,13.7761424 11.0399386,13.5 C11.0399386,13.4872031 11.0404299,13.4744109 11.0414114,13.4616518 L11.4644883,7.96165175 C11.4845267,7.70115317 11.7017474,7.5 11.9630156,7.5 Z" id="Path-107" fill="#000000"></path>
															...
															<div class="kt-notification__item-details">
																...
																<div class="kt-notification__item-time">
																11 Desember 2019 - 15:00 WITA - By <b>Muhammad Nasrullah</b>
																</div>
															</div>
															<div onclick="window.location='#';" class="btn btn btn-outline-danger btn-elevate  btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="fa fa-eye"></i>
													...
													<div class="kt-widget2">
														<div class="kt-widget2__item versi-2 kt-widget2__item--primary">
															...
															<div class="kt-widget2__actions">
																<a href="#" class="btn btn btn-outline-danger btn-elevate  btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
																	<i class="fa fa-eye"></i>
																</a>
															</div>
														</div>
