...
<!--begin:: Widgets/Stats-->
									...
									<table class="table table-responsive table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										<thead style="text-align:center">
											<tr>
												...
												<th width="1%" bgcolor="#f7fcff" rowspan="2" colspan="2">Bunga</th>
												<th width="3%" bgcolor="#f7fcff" rowspan="2" colspan="2">Tenor</th>
											...
											<tr>
											  <th width="1%" bgcolor="#f7fcff">Atasan<br>Langsung</th>
												...
												<th width="1%" bgcolor="#f7fcff">Kabag<br>Umum</th>
  ...
  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 80%">8 dari 10</div>
											  ...
											  <td style="text-align:center" nowrap><span class="kt-badge kt-badge--success kt-badge--md kt-badge--rounded" data-toggle="kt-tooltip" data-skin="brand" title="Disetujui<hr>Muhammad Nasrullah, S.Kom<br>31 Desember 2018 - 14:30 WITA" data-html="true">
												...
												<td style="text-align:center" nowrap><button type="button" class="btn btn-info btn-sm btn-icon" data-toggle="kt-tooltip" data-skin="brand" title="Terbayar"><i class="fa fa-money-bill-alt"></i></button></td>
