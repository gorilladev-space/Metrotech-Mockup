							...
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
									<div class="dropdown dropdown-inline" ddata-placement="left">
											<a href="pegawai-surat-keterangan-kerja.php" class="btn btn-label-primary btn-sm" data-toggle="dropdown" onclick="goBack()">
                ...
                <div class="kt-portlet kt-portlet--height-fluid-full" id="kt_page_portlet">
                    ...
                    <div class="kt-portlet__body">
                      <div class="row">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail Pemohon</div><br>
										 <div class="kt-portlet__body">
...
<div class="kt-separator kt-separator--border-dashed kt-separator--space-lg kt-separator--portlet-fit"></div>
					  <div class="form-group row">
                        <div class="col-lg-8">
                          ...
                          <textarea class="form-control" id="exampleTextarea" rows="4" disabled="disabled" >Kelengkapan Administrasi Pengurusan SKCK</textarea>
                        </div>
                      </div>
                      </div>
                    </div>
...
<div class="form-group row">
		...
		<div class="kt-portlet kt-portlet--height-fluid-full kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
                        ...
                        <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="31 Desember 2019 - 09:00 WITA">
								...
								<div class="col-xl-4">
		<div class="kt-portlet kt-portlet--height-fluid-full kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Verifikasi Direktur Utama</div><br>
