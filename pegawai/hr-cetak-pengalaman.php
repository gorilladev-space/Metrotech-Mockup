				...
				<tr>
												<td colspan="3">
													<div align="center" class="mb-3">
														<span style="font-family: Roboto; font-size: 14px; margin-bottom:3rem">
															<b><u>S U R A T  &nbsp;&nbsp;&nbsp;  K E T E R A N G A N</u>
										...
										<tr>
											<td colspan="2" valign="top">
													<table border="0" class="mt-3" style="width: 600px; line-height:18px; text-align:justify">
														<tbody>
															<tr>
																<td><span style="font-size: 11px;">Adalah benar pernah bekerja pada PT. Ilugroup Multimedia Indonesia terhitung sejak tanggal     10 Januari 2019 hingga 15 Oktober 2019 dengan jabatan sebagai Hardware Specialist Supervisor. Selama bekerja di perusahaan kami, yang bersangkutan telah bekerja dengan baik dalam mengerjakan tugas dan tanggung jawabnya serta tidak pernah terlibat dalam tindakan yang merugikan perusahaan.</span></td>
															</tr>
														</tbody>
													</table>
													</td>
				...
				<tr>
					<td colspan="2" valign="top">
							<table border="0" class="mt-3" style="width: 600px; line-height:18px; text-align:justify">
								<tbody>
									<tr>
										<td><span style="font-size: 11px;">Demikian surat keterangan ini dibuat dengan sebenar-benarnya untuk dipergunakan sebagaimana mestinya.</span></td>
									</tr>
								</tbody>
							</table>
							</td>
