...
function goBack() {
  window.history.back();
						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail Cuti</div><br>
                     ...
                     <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Cuti Tahunan">
                        ...
                        <div class="col-lg-4">
                         ...
                         <input type="text" class="form-control form-control-sm" disabled="disabled" placeholder="Mahdinar, SE">
                        </div>
						<div class="col-lg-2">
