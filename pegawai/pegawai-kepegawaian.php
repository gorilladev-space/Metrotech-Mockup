                ...
                <div class="kt-portlet kt-portlet--height-fluid-full" id="kt_page_portlet">
                    <div class="kt-portlet__body">
                     ...
                     <div class="form-group row">
						...
						<div class="col-lg-6">
																						<label>SK Pegawai Tetap / Kontrak :</label>
																						<input type="text" class="form-control form-control-sm" value="004/20-S.Kep.Dir/PERUMDA-PMR/XI/2022" placeholder="= Pilih Tanggal =" id="kt_datepicker_2" disabled>
																					</div>
