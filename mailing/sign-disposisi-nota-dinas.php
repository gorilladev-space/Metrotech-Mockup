	...
	<div class="kt-container  kt-container--fluid ">
		...
		<div class="kt-subheader__toolbar">
			<div class="dropdown dropdown-inline" ddata-placement="left">
				<a href="nota-dinas.php" class="btn btn-label-primary btn-sm">
											...
											<ul class="nav nav-pills nav-fill" role="tablist">
												<li class="nav-item m-tabs__item">
													<a class="nav-link m-tabs__link active" data-toggle="tab" href="#m_tabs_6_1" role="tab">
														<i class="fa fa-envelope-open"></i> Lampiran Nota Dinas
													</a>
												</li>
...
<div class="kt-portlet kt-portlet--height-half kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							...
							<!--end:: Portlet-->
								...
								<div class="col-xl-6">
									...
									<!--begin::Portlet-->
										<div class="kt-portlet kt-portlet--height-fluid kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
							<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Detail Nota Dinas</div><br>
										 <div class="kt-portlet__body">
                      <div class="form-group row">
                       <div class="col-lg-4">
  ...
  <tr>
    ...
    <td><label class="kt-checkbox kt-checkbox--success">
				...
				<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Data Tembusan Surat</div><br>
 ...
 <div class="kt-portlet__body">
							...
							<!--end:: Portlet-->
									...
									<div class="row">
										<div class="col-lg-12">
                <div class="kt-portlet kt-portlet--height-fluid-full kt-portlet__head kt-ribbon kt-ribbon--right kt-ribbon--danger">
				<div class="kt-ribbon__target" style="top: 2px; right: -2px;">Data File Lampiran</div><br>
