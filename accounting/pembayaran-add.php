							...
							<div class="kt-form__action text-center">
								<div class="btn-group" role="group">
									...
									<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
										...
										<a class="dropdown-item" href="#" data-toggle="modal" data-target="#kt_modal_pencatatan_beban">Pencatatan Beban</a>
										<a class="dropdown-item" href="#" data-toggle="modal" data-target="#kt_modal_pencatatan_gaji">Pencatatan Gaji</a>
										<a class="dropdown-item" href="#" data-toggle="modal" data-target="#kt_modal_PPh_pembelian">PPh Pembelian</a>
										<a class="dropdown-item" href="#" data-toggle="modal" data-target="#kt_modal_PPh_penjualan">PPh Penjualan</a>
									</div>
								</div>
							</div>
						</div>
