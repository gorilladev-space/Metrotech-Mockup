																							...
																							<div class="kt-portlet__body">
																								<div class="kt-portlet__content">
																									<div class="form-group row" style="text-align:left">
																										<div class="col-lg-12">
																										<label>UID :</label>
																											<input type="text" class="form-control form-control-sm" placeholder="Masukkan UID Finger">
																							...
																							<div class="kt-portlet__body">
																								<div class="kt-portlet__content">
																									<div class="form-group row" style="text-align:left">
																										<div class="col-lg-12">
																										<label>UID :</label>
																											<input type="text" class="form-control form-control-sm" placeholder="UID Face Recoginition">
